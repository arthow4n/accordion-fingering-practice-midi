...
export const defaultTrainingRequest = (): TrainingRequest => ({
  ...
  rhythm:{meters:[{beats:4,beatUnit:4}],noteValue:"eighth",style:"mostlySteady",smallestSubdivision:"eighth",syncopation:.1,restDensity:.05,tieDensity:.05,noteDensity:.55},
