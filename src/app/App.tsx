...
import { accompanimentInstruction, accompanimentStylesForMeter } from "../core/patterns/accompanimentTemplates";
...
const bassPatterns:readonly {value:TrainingRequest["leftHand"]["accompanimentStyle"];label:string}[]=[{value:"bassChord",label:"Bass + chord"},{value:"alternatingBass",label:"Alternating bass"},{value:"polka",label:"Polka"},{value:"waltz",label:"Waltz"},{value:"tango",label:"Tango"},{value:"swing",label:"Swing"}];
