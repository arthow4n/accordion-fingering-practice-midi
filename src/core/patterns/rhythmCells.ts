...
export const RHYTHM_CELLS: readonly RhythmCell[] = [
  { id: "quarters", meters: ["4/4"], atoms: [{duration:q},{duration:q},{duration:q},{duration:q}], complexity:.05 },
  { id: "halves", meters: ["4/4"], atoms: [{duration:2*q},{duration:2*q}], complexity:.05 },
  { id: "paired-eighths", meters: ["4/4"], atoms: Array.from({length:8}, () => ({duration:q/2})), complexity:.2 },
  ...
  { id: "dotted-eighth-sixteenth", meters: ["4/4"], atoms: Array.from({length:4}, () => [{duration:3*q/4},{duration:q/4}]).flat(), complexity:.5 },
  ...
  { id: "three-paired-eighths", meters: ["3/4"], atoms: Array.from({length:6},()=>({duration:q/2})), complexity:.2 },
  { id: "three-sixteenths", meters: ["3/4"], atoms: Array.from({length:12},()=>({duration:q/4})), complexity:.55 },
  { id: "three-eighth-sixteenths", meters: ["3/4"], atoms: Array.from({length:3},()=>[{duration:q/2},{duration:q/4},{duration:q/4}]).flat(), complexity:.45 },
  { id: "three-dotted-eighths", meters: ["3/4"], atoms: Array.from({length:3},()=>[{duration:3*q/4},{duration:q/4}]).flat(), complexity:.5 },
