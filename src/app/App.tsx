 ...
 return <main>
  ...
  <fieldset><legend>Practice settings</legend>
   ...
   <details><summary>Advanced generation</summary>
    ...
    <IntegerInput label="Left min jump" value={settings.leftHand.minJump} min={0} max={11} onCommit={minJump=>updateSettings({...settings,leftHand:{...settings.leftHand,minJump,maxJump:Math.max(minJump,settings.leftHand.maxJump)}})}/>{" "}
    <IntegerInput label="Left max jump" value={settings.leftHand.maxJump} min={0} max={11} onCommit={maxJump=>updateSettings({...settings,leftHand:{...settings.leftHand,minJump:Math.min(maxJump,settings.leftHand.minJump),maxJump}})}/>{" "}
