...
export const defaultTrainingRequest = (): TrainingRequest => ({
  ...
  rightHand:{range:{low:55,high:91},movementDifficulty:.4},leftHand:{enabled:true,accompanimentStyle:"bassChord",movementDifficulty:.35},coordination:{difficulty:.3},
